...
public class FinderServiceTest {
    ...
    public void oneToFour() throws Exception {
        ...
        Assert.assertEquals(expectedOutput, FinderService.findLongestConsonantChain(words));
    }
    ...
    public void notOnlyLettersInTheEnd() {
        ...
        ArrayList<String> notCorrectArray = new ArrayList<>(Arrays.asList(_notCorrectArray));

        FinderService.findLongestConsonantChain(notCorrectArray);
