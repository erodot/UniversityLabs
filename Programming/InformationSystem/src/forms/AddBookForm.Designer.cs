namespace InformationSystem
{
    partial class AddBookForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.authorsTableAdapter = new ArchiveData.DSArchiveTableAdapters.AuthorsTableAdapter();
            ...
            // authorFirstComboBox
            // 
            this.authorFirstComboBox.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue", this.authorFirstBindingSource, "ID", true));
            ...
            // 
            // authorFirstBindingSource
            // 
            this.authorFirstBindingSource.DataMember = "Authors";
            this.authorFirstBindingSource.DataSource = this.dsArchive;
            // 
            // dsArchive
            // 
            ...
            // categoryComboBox
            // 
            this.categoryComboBox.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue", this.categoryBindingSource, "ID", true));
            ...
            this.categoryBindingSource.DataSource = this.dsArchive;
            // 
            // facultyLabel
            // 
            ...
            // departmentComboBox
            // 
            this.departmentComboBox.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue", this.facultyBindingSource, "ID", true));
            ...
            // 
            this.authorSecondComboBox.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue", this.authorSecondBindingSource, "ID", true));
            ...
            // 
            // authorSecondBindingSource
            // 
            this.authorSecondBindingSource.DataMember = "Authors";
            this.authorSecondBindingSource.DataSource = this.dsArchive;
            // 
            ...
            // authorThirdComboBox
            // 
            this.authorThirdComboBox.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue", this.authorThirdBindingSource, "ID", true));
            ...
            // 
            // authorThirdBindingSource
            // 
            this.authorThirdBindingSource.DataMember = "Authors";
            this.authorThirdBindingSource.DataSource = this.dsArchive;
            // 
        ...
        private ArchiveData.DSArchiveTableAdapters.AuthorsTableAdapter authorsTableAdapter;
